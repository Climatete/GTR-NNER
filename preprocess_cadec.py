...
# The directory that contains "train.json", "dev.json" and "test.txt" outputted by Dai's preprocessing code
...
if __name__ == "__main__":
    ...
    do_stat(os.path.join(daiACL2020_preprocess_dir, 'train.json'), 'train', True, os.path.join(temp_output_dir, 'train.json'))
    do_stat(os.path.join(daiACL2020_preprocess_dir, 'dev.json'), 'dev', True, os.path.join(temp_output_dir, 'dev.json'))
    ...
    with StanfordCoreNLP(stanfordcorenlp_dir, memory='8g', timeout=60000) as nlp:
        ...
        # for cadec
        train_instances = read_file(os.path.join(temp_output_dir, 'train.json'))
        dev_instances = read_file(os.path.join(temp_output_dir, 'dev.json'))
