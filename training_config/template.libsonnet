...
function(p) {
  ...
  local token_indexers = {
    ...
    [if use_bert then "bert"]: {
      ...
      pretrained_model: "Bio_ClinicalBERT/vocab.txt",
      //pretrained_model: "scibert_scivocab_cased/vocab.txt",
  ...
  local text_field_embedder = {
    ...
    token_embedders: {
      ...
      [if use_bert then "bert"]: {
        type: "bert-pretrained",
        //pretrained_model: "multi_cased_L-12_H-768_A-12/weights.tar.gz",
        pretrained_model: "Bio_ClinicalBERT/weights.tar.gz",
        //pretrained_model: "scibert_scivocab_cased/weights.tar.gz",
